...
import HeavenSmile from "../assets/about/HeavenSmile.gif"
import IllyaCat from "../assets/about/IllyaCat.gif"
import Believe from "../assets/about/KaleidBelieve.gif"
import Freakout from "../assets/about/IllyaFreakOut.gif"
import IllyaCute from "../assets/about/illyaCute.gif"

import BerserkerAudio from '../assets/about/berserker.mp3'
import IllyaArcherAudio from '../assets/about/archer.mp3'
import IllyaCasterAudio from '../assets/about/caster.mp3'
import Sitonai from "../assets/about/sitonai.mp3"
import WalnutGame from "../assets/about/walnutGame.mp3"
...
const playAudio1 = () =>{
 document.querySelector('#voice1').innerHTML = `<audio autoplay src = ${BerserkerAudio}/>`
}

const playAudio2 = () =>{
  document.querySelector('#voice2').innerHTML = `<audio autoplay src = ${IllyaArcherAudio}/>`
 }
 
 const playAudio3 = () =>{
  document.querySelector('#voice3').innerHTML = `<audio autoplay src = ${IllyaCasterAudio}/>`
 }

 const playAudio4 = () =>{
  document.querySelector('#voice4').innerHTML = `<audio autoplay src = ${Sitonai}/>`
 }

 
 const playAudio5 = () =>{
  document.querySelector('#voice5').innerHTML = `<audio autoplay src = ${WalnutGame}/>`
 }
  ...
  return (
    ...
    <label id = 'audio' className = 'flex justifyContent' htmlFor="audioSwitch">Turn audio off</label>

    <input type = 'checkbox' id = 'audioSwitch' name = 'audioSwitch' checked = {audio} value = {audio} onChange = {(e)=> {
    ...
    <img src = {HeavenSmile} onClick={()=>audio ? alert('Audio is off') : playAudio1()} alt = 'Illya gif of her smiling and twirling around'/>
   <div id = 'voice1' className = 'hidden'>

   <audio className = 'audio1' autoplay src = {BerserkerAudio}/>
    ...
    <img src = {IllyaCat} onClick={()=>audio ? alert('Audio is off') : playAudio2()} alt = 'Illya gif of her smiling and twirling around'/>
   <div id = 'voice2' className = 'hidden'></div>
    </div>
    ...
    <div className = 'image flex justifyContent'>
      <img src = {Believe} onClick={()=>audio ? alert('Audio is off') : playAudio3()} alt = 'Illya believes and makes a fist'/>
      <div id = 'voice3' className = 'hidden'></div>
    </div>
        ...
        <div className = 'image flex justifyContent'>
      <img src = {Freakout} onClick={()=>audio ? alert('Audio is off') : playAudio4()} alt = 'Illya freaking out and grabbing her head by the sides with both hands'/>
      <div id = 'voice4' className = 'hidden'></div>
        </div>
        ...
        <div className = 'image flex justifyContent'>
      <img src = {IllyaCute} onClick={()=>audio ? alert('Audio is off') : playAudio5()} alt = 'Illya finds a walnut on a snow tree'/>
      <div id = 'voice5' className = 'hidden'></div>
        </div>
