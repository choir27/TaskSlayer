...
const About = () => {
  ...
  useEffect(() => {
    const addAudio = async() =>{
      try{
        audioElement = new Audio(currentAudio);
      ...
      <div id="main">
        <section className="post">
          <article className="major">
            ...
            <div className = 'image flex column justifyContent'>

              <img 
              src = {Assets.HeavenSmile} 
              onClick={()=>audio ? 
              alert('Audio is off') : 
              handlePlayAudio(Assets.BerserkerAudio)
            ...
            <div className="image flex column justifyContent">
              ...
              <img 
                ...
                audio ? 
                alert('Audio is off') : 
                handlePlayAudio(Assets.IllyaArcherAudio)
        ...
        <div className = 'image flex column justifyContent'>
          ...
          onClick={()=>audio ? 
          alert('Audio is off') : 
          handlePlayAudio(Assets.IllyaCasterAudio)
          } alt = 'Illya believes and makes a fist'
          />
        ...
        <div className = 'image flex column justifyContent'>
          ...
          audio ? 
          alert('Audio is off') : 
          handlePlayAudio(Assets.Sitonai)
          } 
        ...
        <div className = 'image flex column justifyContent'>
          ...
          audio ?
          alert('Audio is off')
          : handlePlayAudio(Assets.WalnutGame)
